...
export default function CertificationBadge({ 
  ...
  return (
    <div className="w-full flex flex-col bg-white rounded-b-[20px] border-t-0 border border-neutral-50 lg:pt-5 lg:px-6 lg:pb-6 p-4 gap-4">
      <Typography variant={{ base: "title-3", lg: "title-1" }} color="neutral-900">
        Get a "Certified verified" badge
      </Typography>
      ...
      <button 
        ...
        disabled={isUploading}
        className="flex justify-center items-center p-4 w-[150px] h-[150px] rounded-2xl border border-deep-royal-indigo-100 border-dashed hover:border-deep-royal-indigo-200 transition-colors overflow-hidden relative disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {previewUrl ? (
          <img
            src={previewUrl}
      ...
      <div className="flex flex-col gap-1">
        ...
        {externalError && (
          <Typography variant="body-3" color="red-500" className="mt-1">
            {externalError}
          </Typography>
        )}
      </div>
